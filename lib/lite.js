...
module.exports = (function(request, response) {
    ...
    var _get = function (request, response, url, reqMethod, params) {
        var controller = require(configLite.controller);
    ...
    var viewsHTMLPaths = {
      set: function(key, viewObjPaths) {
         return (key in viewObjPaths) ? viewObjPaths[key] : configLite.errorFilePath;
      }  
    };
    ...
    var _init = function(request, response) {
        ...
        * */
        , filePath = function(url) {
            ...
            if (!ext && url) {
                fPath = require(configLite.viewsRoutes)(url, viewsHTMLPaths);
        ...
        * */
        setTemplateRenderedView = function (path, controllerFetch, content) {
            var renderContent;
            switch (configLite.templateEngine) {
                case 'swig':
        ...
        fs.exists(fPath.path, function(exists) {
            ...
            if (exists) {
                ...
                if (fetchedResponse) {
                    ...
                    var contentError = setTemplateRenderedView(configLite.errorFilePath);
